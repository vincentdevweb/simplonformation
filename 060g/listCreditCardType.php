...
<head>
    ...
    <title><?= $dictionnary['listCreditCardType.page.title'] ?></title>
</head>
...
<body class="container">
    ...
    <main>
        <h1><?= $dictionnary['listCreditCardType.page.title'] ?></h1>

        <?php $linesAsArrays = readLinesFromCSV('creditCardType.csv'); ?>
